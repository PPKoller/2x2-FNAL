...
\item {\bf December 2019:} ready to take data. \todo{This is obviously very tentative, but we should definitely check what the NuMI run plan is... there's not much point pushing an ambitious schedule if we arrive in a long shutdown}
\end{itemize}
