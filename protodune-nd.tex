...
\todo{Whether or not the HPgTPC prototype is available, it would be good to use MINERvA, downstream of the 2x2, or downstream of the HPgTPC, depending on what we have. Need to check this politically, and to approach MINERvA people.}
