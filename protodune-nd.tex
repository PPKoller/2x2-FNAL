...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.45\linewidth]{plots/cryostat_opt.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{plots/BathAndModule_opt.png}
...
\begin{figure}[tbp]
  \centering
  \includegraphics[width=0.8\textwidth]{plots/Normal-Module-4K_labelled_opt.png}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=0.75 \linewidth]{plots/1Film50x10_opt.png}
...
As the LAr component of ProtoDUNE-ND may have to be moved in order to accommodate new prototype modules as they become available. Testing a moveable cryogenic system is also beneficial because a similar approach will be required if a moveable LAr detector is required for DUNE-PRISM at the DUNE ND.
