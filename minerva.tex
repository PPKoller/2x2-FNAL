...
\todo{James, I fleshed out the above a little, but I'm not sure what quantitative studies we can put below...}

\subsubsection{Validation of multiple coulomb scattering}
\todo{Do we need the MINOS magnet on? Can do a range measurement without.}
