...
\begin{figure}[htb]
  \centering
  \subfloat[Front view] {\label{fig:minerva_detector_front}\includegraphics[width=0.35\textwidth]{plots/minerva_module_transverse.pdf}}
...
\begin{figure}[htb]
  ...
  \caption{Correlation between tracks}
